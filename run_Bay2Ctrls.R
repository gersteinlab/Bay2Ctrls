...
curr.ip.file <- iparams$ip.file # file is in original directory
curr.input4ip.file <- iparams$input4ip.file # file is in original directory
curr.mock.file <- iparams$mock.file # file is in original directory
curr.input4mock.file <- iparams$input4mock.file # file is in original directory
